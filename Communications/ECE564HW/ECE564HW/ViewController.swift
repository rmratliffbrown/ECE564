...
class ViewController: UIViewController, UITextFieldDelegate {
    ...
    override func viewDidLoad() {
        ...
        fnameField.text = person.firstname
        lnameField.text = person.lastname
        fromField.text = person.wherefrom
        progLangField.text = person.languages.joined(separator: ",")
        hobbyField.text = person.hobbies.joined(separator: ",")
        genderSelect = person.gender
        roleField = person.role
        ...
        // TODO: Set images
        personImageView.image = person.picture.toImage() ?? UIImage(systemName: "person.circle.fill")
//        if person.firstname == "Rashaad" && person.lastname == "Ratliff-Brown" {
//            personImageView.image = UIImage(named: "image")
//        } else {
//            personImageView.image = UIImage(named: person.picture) ?? UIImage(systemName: "person.circle.fill")
//        }
...
//    }
    ...
    private func dismissAfterBriefPause() {
